...
public class MainActivityTest {
    ...
    public void checkList(){
        ...
        assertTrue(solo.waitForText("Edmonton", 1, 10000));
    ...
    public void checkCiyListItem(){
        ...
        solo.waitForText("Edmonton", 1, 5000);
